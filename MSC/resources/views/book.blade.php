        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>Hello there?</h4>
              <h6 class="font-weight-light">Book a slot. It only takes a few steps</h6>
              <form method="POST" action="/book" class="pt-3">
                @csrf
            ...
            <div class="form-group">
              ...
              <label for="slot" style="color: red">No sunday slot Created</label>
              @else
